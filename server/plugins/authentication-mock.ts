...
export default defineNitroPlugin((nitroApp) => {
	...
	nitroApp.router.post(`/${authenticationConfig.basePath}${authenticationConfig.systemPath}${authenticationConfig.defaultSystem}/${authenticationConfig.defaultSystem}/${authenticationConfig.signInPathName}`, defineEventHandler(async (event) => {
